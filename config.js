...
module.exports = {  
  ...
  PACKNAME: process.env.PACKNAME || "GHOST-RIDER",
  AUTHOR: process.env.AUTHOR || "GHOST-RIDER",
  SUDO: process.env.SUDO || "263716394979",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "",
  OWNER_NAME: process.env.OWNER_NAME || "TcroneB HackX",
  HEROKU: toBool(process.env.HEROKU) || false,
  BOT_NAME: process.env.BOT_NAME || "GHOST-RIDER",
