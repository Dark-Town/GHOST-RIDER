...
console.log("CONNECTING GHOST-RIDER🧬...");
...
console.log('GHOST-RIDER CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *GHOST-RIDER ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴋɢ ᴛᴇᴄʜ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs GHOST-RIDER*

*https://whatsapp.com/channel/*

> *❁ᴊᴏɪɴ ᴏᴜʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs GHOST-RIDER*

*https://youtube.com/*

*╭⊱✫🐲 GHOST-RIDER 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *GHOST-RIDER*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *TCRONEB HACKX & CRUZ THE TRADER🇿🇼*
...
app.get("/", (req, res) => {
res.send("HEY, GHOST-RIDER STARTED ✅");
});
